package com.smartverse.churchlitebackend.model.dashboard;
...
public final class DashboardModels {
    ...
    public record DashboardFilters(List<FilterOption> bancos, List<FilterOption> contasBancarias,
                                   List<FilterOption> caixas, List<FilterOption> centrosCusto,
                                   List<FilterOption> planosConta) {
    }

    public record FinancialSnapshot(FinancialSummary resumo, List<EvolutionPoint> evolucao,
                                    List<CostCenterExpense> despesasPorCentroCusto,
                                    List<PlanAccountExpense> despesasPorPlanoConta,
