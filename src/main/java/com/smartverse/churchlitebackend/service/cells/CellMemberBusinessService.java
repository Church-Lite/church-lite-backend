...
import com.smartverse.churchlitebackend_gen.dtos.CellMemberDTO;
import com.smartverse.churchlitebackend_gen.enums.CellMemberStatus;
import com.smartverse.churchlitebackend_gen.services.CellMemberService;
...
@Service
public class CellMemberBusinessService extends CellMemberService {
    @Override
    @Transactional
    public CellMemberDTO save(CellMemberDTO dto) {
        validate(dto, null);
    ...
    @Override
    @Transactional
    public CellMemberDTO update(CellMemberDTO dto, UUID id) {
        validate(dto, id);
    ...
    public void delete(UUID id) {
        throw new ServiceException(HttpStatus.BAD_REQUEST, "Vínculos devem ser encerrados, não excluídos");
    }
    ...
    private void validate(CellMemberDTO dto, UUID id) {
        ...
        if (dto.isPrimaryCell()) {
            ...
            if (primary)
                throw new ServiceException(HttpStatus.CONFLICT, "A pessoa já possui outra célula principal ativa");
        }
    }
}
