...
@RestController
public class CellAttendanceHandlerImpl extends CellAttendanceHandler {
    @Override @Transactional
    public CellAttendanceDTO save(CellAttendanceDTO dto) { validate(dto, null); return super.save(dto); }

    @Override @Transactional
    public CellAttendanceDTO update(CellAttendanceDTO dto, UUID id) { validate(dto, id); return super.update(dto, id); }
