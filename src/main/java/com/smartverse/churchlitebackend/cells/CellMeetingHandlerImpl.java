...
@RestController
public class CellMeetingHandlerImpl extends CellMeetingHandler {
    ...
    private void clearWorkflow(CellMeetingDTO dto) {
        dto.setSubmittedAt(null); dto.setSubmittedBy(null); dto.setReviewedAt(null); dto.setReviewReason(null); dto.setCancellationReason(null);
    }
}
