...
@RestController
public class CellPrayerRequestHandlerImpl extends CellPrayerRequestHandler {
    @Override @Transactional
    public CellPrayerRequestDTO save(CellPrayerRequestDTO dto) { validate(dto); return super.save(dto); }

    @Override @Transactional
    public CellPrayerRequestDTO update(CellPrayerRequestDTO dto, UUID id) { validate(dto); return super.update(dto, id); }
